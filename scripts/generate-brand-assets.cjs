...
/**
 * DOMINUS Official Brand Asset Generator — v2.0 "La Clave de Bóveda"
 *
...
function sdfDominus(px, py, isMaskable) {
...
function samplePixel(nx, ny, isMaskable) {
  ...
  // 2. Glifo D
  const dGlyph = sdfDominus(nx, ny, isMaskable);
  const AA = 0.007;
...
console.log('🏛️  DOMINUS — Generando brand assets v3.0 "SIGIL"\n');
...
console.log('\n🎉 ¡Assets DOMINUS v2.0 generados con éxito!');
