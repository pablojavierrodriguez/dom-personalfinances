...
flowchart TD
    ...
    subgraph Fase2 ["Fase 2: Frontend & Design System"]
        ...
        F2_2["2.2 Componentes <DominusLogo /> y SVG"]
...
- [x] **2.2 Componente centralizado de Logotipo e Isotipo:**
  - Crear `src/components/ui/DominusLogo.tsx` y `DominusSymbol.tsx` como componentes React optimizados con SVG embebido, soportando propiedades `className`, variantes de tamaño y color.
...
| `src/components/ui/DominusLogo.tsx` | UI / Branding | Componente SVG y wordmark reutilizable accesible (Completado). |
| `src/components/ui/DominusSymbol.tsx` | UI / Branding | Monograma D arquitectónico con clave de bóveda (Completado). |
